#cantp: Inside cantp contain three main functions related to processing data fragmentation before transmit and receive via CAN bus, next to it is a function to Send flowcontrol
